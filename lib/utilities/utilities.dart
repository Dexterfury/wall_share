  ...
  static Future<String> uploadImageToFirebaseStorage({
    ...
    try {
      UploadTask uploadTask =
          FirebaseStorage.instance.ref().child(reference).putFile(imageFile);
  ...
  static String generateCategory(String prompt) {
    ...
    if (promptLower.contains(RegExp(r'abstract|pattern|'))) {
      ...
      return categories[2];
        ...
        .contains(RegExp(r'minimal|simple|clean|minimalist'))) {
      return categories[3];
    } else if (promptLower
        .contains(RegExp(r'sci-fi|futuristic|space|alien|robot'))) {
      return categories[4];
    } else if (promptLower.contains(RegExp(r'fantasy|magic|mythical|dragon'))) {
      return categories[5];
    } else if (promptLower
        .contains(RegExp(r'art|painting|abstract|expressionist'))) {
      return categories[6];
