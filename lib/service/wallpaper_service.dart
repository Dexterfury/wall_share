...
class WallpaperService {
  ...
  static Future<void> downloadWallpaper({
    ...
    final newWalllpapeName =
        walllpapeName.replaceAll(' ', '').replaceAll('_', '-');
              ...
              children: [
                ...
                ListTile(
                  ...
                  onTap: () async {
                    ...
                    await _applyWallpaper(
                        context, filePath, WallpaperManagerPlus.homeScreen);
                  },
                ),
                ...
                ListTile(
                  ...
                  onTap: () async {
                    ...
                    // apply wallapper to home screen
                    await _applyWallpaper(
                        context, filePath, WallpaperManagerPlus.lockScreen);
                  },
                ),
                ...
                ListTile(
                  ...
                  onTap: () async {
                    ...
                    // apply wallapper to home screen
                    await _applyWallpaper(
                        context, filePath, WallpaperManagerPlus.bothScreens);
                  },
                ),
              ],
            ),
    ...
    try {
      ...
      if (context.mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              result ?? 'There was an error setting the wallpaper',
            ),
          ),
        );
      }
